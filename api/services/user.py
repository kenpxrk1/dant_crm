...
class UserService():
    ...
    async def create_super_user(self, user_data: dict = super_user.super_user_data) -> None:
    ...
    async def update_user(self, user_data: UserUpdateDTO, id: UUID,  session) -> UserReadDTO:
        user_data = user_data.model_dump()
